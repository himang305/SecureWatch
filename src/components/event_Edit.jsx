...
function Event_Edit() {
  ...
  useEffect(() => {
    const fetchMoniterEvents = async () => {
      try {
        setLoading(true);
  ...
  return (
    ...
    {transfer?(<>
          ...
          <input
            ...
            required
            onChange={(e) =>{setTransferInputs({...transferInputs, from: e.target.value})}}
          />
          <input
            className="w-full rounded-lg p-2 outline-none border border-[#4C4C4C]"
            style={{ backgroundColor: "white" }}
            ...
            required
            onChange={(e) =>{setTransferInputs({...transferInputs, to: e.target.value})}}
          />
          <input
            className="w-full rounded-lg p-2 outline-none border border-[#4C4C4C]"
            style={{ backgroundColor: "white" }}
            placeholder="uint256"
            required
            onChange={(e) =>{setTransferInputs({...transferInputs, value: e.target.value})}}
          />
          </div>
        </>):null}
    {approval?(<>
          ...
          <input
            ...
            placeholder="from:address"
            required
            onChange={(e) =>{setApprovalInputs({...approvalInputs, from: e.target.value})}}
          />
          <input
            className="w-full rounded-lg p-2 outline-none border border-[#4C4C4C]"
            style={{ backgroundColor: "white" }}
            placeholder="to:address"
            required
            onChange={(e) =>{setApprovalInputs({...approvalInputs, to: e.target.value})}}
          />
          ...
          <input
            ...
            placeholder="uint256"
            required
            onChange={(e) =>{setApprovalInputs({...approvalInputs, value:`${operator}::${e.target.value}`})}}
          />
          </div>
          </div>
        </>):null}
