...
function home() {
  return (
    <div className="mt-10 flex flex-col justify-center items-center">
      <Navbar />
      <button className="rounded-md px-4 py-2 text-white bg-black mt-10">
      ...
      <div className="text-[#8F8F8F] mt-10">
        Unlock the Future of Transaction Security – Proactive Monitoring,
      </div>
      <div className="text-[#8F8F8F]">
        Intuitive Insights, and Seamless Scalability Await You with SecureWatch
      </div>
      <Link to="/dashboard">
        <button className="rounded-md px-4 py-2 text-white bg-black mt-10">
          Start for free
      ...
      <div className="grid grid-cols-2 grid-rows-3 w-4/6">
        <div
          className="rounded-md mx-3 p-4"
          style={{ border: "2px solid #E5E5E5" }}
        >
          <img src={Security} alt="" />
          <div className="text-3xl">Proactive Security</div>
          <div>
            Identify and address potential security threats in real-time with
            advanced algorithms and continuous monitoring, ensuring the
        ...
        >
          ...
          <div>
            Build trust with your users by safeguarding their critical
            transactions, providing a secure environment that fosters confidence
            and loyalty.
          </div>
        </div>
        <div
          className="rounded-md mt-4 mx-3  p-4"
          style={{ border: "2px solid #E5E5E5" }}
        >
          <img src={Security} alt="" />
          <div className="text-3xl">Peace of Mind</div>
          <div>
            Focus on business growth while SecureWatch takes care of transaction
            security, providing you peace of mind and allowing you to
            concentrate on strategic objectives.
          </div>
        </div>
        <div
          className="rounded-md  mt-4 mx-3  p-4"
        ...
        >
          ...
          <div>
            ...
            built-in reporting features, facilitating audits and demonstrating a
      ...
      <div className="w-1/2 text-5xl mt-10">
        Try SecureWatch now, it's free and easy to set up
      </div>
      <button className="rounded-full px-4 py-2 text-white bg-black mt-5">
        Sign Up-it's free
      </button>
      <div className="mt-10">Need help or have questions?</div>
      <div className="mt-5">
        <span className="mx-2">Transaction Monitor</span>
        <span className="mx-2">Secure Dashboard</span>
        <span className="mx-2">Anomaly Detection System</span>
      </div>
      <div className="mt-2">
        <span lassName="mx-2">Alert and Notification System</span>
